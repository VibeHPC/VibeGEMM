// Compile Command:
// nvcc -O3 -std=c++17 -gencode arch=compute_90a,code=sm_90a --expt-relaxed-constexpr --expt-extended-lambda vibegemm_M12544_N12544_K12544_FP16FP16FP32FP16_H100_submission.cu -lcublas -lcuda -o vibegemm_M12544_N12544_K12544_FP16FP16FP32FP16_H100
//
// Run Command:
// ./vibegemm_M12544_N12544_K12544_FP16FP16FP32FP16_H100
...
static void print_usage(const char *program) {
    ...
    std::printf("\nDefaults:\n");
    std::printf("  M=N=K=12544, warmup_iters=10, benchmark_iters=30\n");
}
