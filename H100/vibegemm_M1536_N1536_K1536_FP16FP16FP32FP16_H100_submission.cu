// Compile Command:
// nvcc -O3 -std=c++17 -gencode arch=compute_90a,code=sm_90a --expt-relaxed-constexpr --expt-extended-lambda vibegemm_M1536_N1536_K1536_FP16FP16FP32FP16_H100_submission.cu -lcublas -lcuda -o vibegemm_M1536_N1536_K1536_FP16FP16FP32FP16_H100
//
// Run Command:
// ./vibegemm_M1536_N1536_K1536_FP16FP16FP32FP16_H100
...
static void launch_custom_gemm(const half *d_A, const half *d_B, half *d_C,
                               int M, int N, int K) {
    constexpr int BM = 128, BN = 192, BK = 64, QSIZE = 3, NUM_THREADS = 384,
                  NUM_SM = 128;
...
static void print_usage(const char *program) {
    ...
    std::printf("\nDefaults:\n");
    std::printf("  M=N=K=1536, warmup_iters=10, benchmark_iters=30\n");
}
