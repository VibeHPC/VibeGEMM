...
// localization: localization:0864eab8b0ed03ac
// target_region: epilogue
// insertion_point: epilogue_cross_thread_reduction_before_global_store
// computation: mean_sq = mean(acc^2, axis=N) -> inv_rms = rsqrt(mean_sq + epsilon) -> Y = acc * inv_rms
