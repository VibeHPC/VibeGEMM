// Compile Command:
// nvcc -O3 -std=c++17 -gencode arch=compute_90a,code=sm_90a --expt-relaxed-constexpr --expt-extended-lambda vibegemm_M6144_N6144_K6144_FP16FP16FP32FP16_H100_submission.cu -lcublas -lcuda -o vibegemm_M6144_N6144_K6144_FP16FP16FP32FP16_H100
//
// Run Command:
// ./vibegemm_M6144_N6144_K6144_FP16FP16FP32FP16_H100
...
__global__ __launch_bounds__(NUM_THREADS) void __cluster_dims__(
    ...
    (void)cluster_count;
    Schedule<1, NUM_SM / CLUSTERS, BM * CLUSTER_M, BN * CLUSTER_N,
...
#undef ST
            ...
            if (threadIdx.x == 128) {
                storeAsync(&tensorMapC, (half *)&sC[0], num_block_m * BM,
                           num_block_n * BN);
...
static void print_usage(const char *program) {
    ...
    std::printf("\nDefaults:\n");
    std::printf("  M=N=K=6144, warmup_iters=10, benchmark_iters=30\n");
}
